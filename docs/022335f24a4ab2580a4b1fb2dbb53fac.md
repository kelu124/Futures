...
| name                      | description                                                                                                                                                                 |   relevancy |
|:--------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| New ESG Framework         | A more focused and measurable approach to Environmental, Social, and Governance criteria that emphasizes stakeholder value and societal impact.                             |           4 |
| Society Operating Systems | The concept that major tech companies function as Society Operating Systems, influencing societal structures and requiring governance aligned with social responsibilities. |           4 |
| Earth Tax                 | A proposed accountability measure for companies to ensure they do not extract more from the earth than can be regenerated, promoting sustainability.                        |           3 |
