...
| name                               | description                                                                                                                     |   relevancy |
|:-----------------------------------|:--------------------------------------------------------------------------------------------------------------------------------|------------:|
| Open Research Communication System | A community-based, scholar-led system for open research communication where authors control publishing decisions.               |           5 |
| Diamond Open Access                | A publishing model where journals operate without charging fees to authors or readers, funded by institutions or organizations. |           4 |
| Publish, Review, Curate Model      | A system where authors post preprints, and academics manage peer-review processes at no cost to authors.                        |           4 |
| Preprint Servers                   | Platforms where researchers can share early versions of their research before peer review, promoting immediate access.          |           4 |
| Transformative Agreements          | Contracts between publishers and institutions that aim to facilitate open access without traditional paywalls.                  |           3 |
