...
| name                                  | description                                                                                                                       |   relevancy |
|:--------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------|------------:|
| In-Car Ordering through Apple CarPlay | Allows customers to place orders via their vehicle's interface, enhancing convenience and integration with daily routines.        |           4 |
| Electric Vehicle Delivery Fleet       | Utilizing electric vehicles for deliveries to reduce emissions and operational costs while addressing driver shortages.           |           5 |
| First-Party Fulfillment               | Focus on internal delivery systems rather than relying solely on third-party aggregators, improving control over service quality. |           4 |
| Training Programs for Franchisees     | Large-scale training initiatives to enhance service and operational efficiency across franchises.                                 |           3 |
