# __Unstable Diffusion: The Controversial Rise of AI-Generated Adult Content__, from ([14793.0](https://kghosh.substack.com/p/14793.0).)
...
| name                                      | description                                                                                                                        |   relevancy |
|:------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------|------------:|
| Stable Diffusion                          | A text-to-image AI that generates realistic and anime-style images from textual descriptions, now being adapted for adult content. |           4 |
| Unstable Diffusion                        | An AI system developed for generating high-quality pornographic content, expanding on the capabilities of Stable Diffusion.        |           5 |
| AI-generated porn                         | The use of AI to create adult content, raising ethical concerns and changing dynamics in the adult art community.                  |           5 |
| Discord bots for image generation         | Automated tools on Discord that allow users to generate AI-generated images, particularly in niche communities.                    |           3 |
| AI training datasets for explicit content | The effort to create and fine-tune datasets specifically for generating adult content with AI systems.                             |           4 |
| Waifu Diffusion                           | A model fine-tuned on anime images to generate adult content, representing a specialization in AI art generation.                  |           3 |
| Ethical AI content moderation             | Systems and guidelines being developed to moderate AI-generated content, particularly in adult contexts, to prevent abuse.         |           5 |
