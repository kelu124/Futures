...
| name                              | description                                                                                                                       |   relevancy |
|:----------------------------------|:----------------------------------------------------------------------------------------------------------------------------------|------------:|
| Direct File program               | A program allowing taxpayers to file taxes directly to the IRS for free, developed through collaboration between 18F and the IRS. |           4 |
| User-friendly government services | Project aimed at improving user experience with government services, impacted by the disbandment of the 18F team.                 |           5 |
| Weather.gov revamp                | An initiative to make the National Weather Service website more user-friendly and stabilize its public API for third-party use.   |           4 |
| CDC Disease Surveillance system   | A system developed to track and prevent diseases, crucial for monitoring dangerous pathogens.                                     |           5 |
| Cloud.gov                         | A platform providing cloud hosting services to government agencies, promoting secure and efficient use of cloud technology.       |           4 |
| Login.gov                         | A service to help Americans sign in to access various government benefits securely.                                               |           5 |
| FedRAMP                           | A program that promotes the adoption of secure cloud services across the government sector.                                       |           4 |
