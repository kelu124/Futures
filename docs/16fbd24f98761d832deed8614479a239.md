# __Amazon's Seller Lending Business Grows Amid Concerns Over Loan Defaults__, (from page [20230122](https://kghosh.substack.com/p/20230122).)
...
| name                                | description                                                                                                                            |   relevancy |
|:------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Seller Lending Programs             | Amazon's seller lending programs that provide loans and financial services to third-party sellers on its platform.                     |           4 |
| Underwriting Process Enhancement    | The tightening and enhancement of underwriting processes to manage credit risk more effectively in response to economic uncertainties. |           4 |
| Invoice Financing Services          | Financial services that allow sellers to receive immediate cash based on their invoices, improving cash flow management.               |           3 |
| Co-branded Credit Cards for Sellers | Credit cards designed for third-party sellers to facilitate transactions and improve purchasing power.                                 |           3 |
| Risk Management Analytics           | Advanced risk management processes that monitor and predict credit risk for lending operations.                                        |           4 |
| Economic Profit Analysis            | New methods for defining and analyzing economic profit within lending and financial operations.                                        |           3 |
