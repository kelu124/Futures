...
| name                      | description                                                                                                             |   relevancy |
|:--------------------------|:------------------------------------------------------------------------------------------------------------------------|------------:|
| Artificial Intelligence   | A branch of computer science focused on creating systems that can perform tasks typically requiring human intelligence. |           5 |
| Distributed AI            | AI systems that operate across multiple locations and devices, improving efficiency and collaboration.                  |           4 |
| Responsible AI            | Developing AI technologies with ethical guidelines to ensure fairness, accountability, and transparency.                |           5 |
| Machine Learning          | A subset of AI that allows systems to learn from data and improve over time without explicit programming.               |           5 |
| Digital Rights Technology | Technologies aimed at protecting and promoting digital rights in the age of digital transformation.                     |           4 |
| AI Governance             | Frameworks and policies designed to oversee and regulate the development and deployment of AI technologies.             |           5 |
| Data Justice              | Ensuring equitable and fair treatment of individuals in the context of data collection and usage.                       |           4 |
| Collaborative AI          | AI systems designed to work alongside humans and other AI systems to enhance productivity.                              |           4 |
| Cybersecurity AI          | AI technologies focused on identifying and mitigating cybersecurity threats.                                            |           4 |
| Health AI                 | AI applications designed to improve healthcare delivery and outcomes through data analysis.                             |           5 |
