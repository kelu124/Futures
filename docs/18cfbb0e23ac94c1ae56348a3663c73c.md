# __BP Energy Outlook 2023: Hydrogen's Role in Decarbonisation Across Sectors__, (from page [20230715](https://kghosh.substack.com/p/20230715).)
...
| name                                   | description                                                                                                   |   relevancy |
|:---------------------------------------|:--------------------------------------------------------------------------------------------------------------|------------:|
| Heat Pumps                             | Efficient systems that displace gas boilers in buildings, reducing energy demand significantly.               |           5 |
| Blue Hydrogen                          | Hydrogen derived from natural gas with carbon capture and storage, used in heavy transport and industry.      |           4 |
| Green Hydrogen                         | Hydrogen produced from renewable energy sources, playing a role in industry and heavy transport.              |           4 |
| Hydrogen-Derived Synthetic Fuels       | Fuels created from hydrogen and CO2, contributing to aviation's energy mix by 2050.                           |           3 |
| Ammonia-based Marine Engine Technology | Technology in development for shipping, using ammonia as a low-cost hydrogen-derived fuel solution.           |           4 |
| Industrial-Scale Heat Pumps            | Technologies capable of producing lower temperature heat for non-heavy industries, enhancing electrification. |           4 |
