...
|:-----------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Workplace Disparities in AI Adoption           | Discrepancies in AI tool usage across industries may widen the divide in workplace efficiencies and opportunities.                              |           4 |
| Generational Dependency on AI Tools            | Younger generations may become overly reliant on AI for work tasks, potentially affecting critical thinking and creativity.                     |           3 |
| Gender Gap in AI Utilization                   | The lower adoption rate of AI tools among women raises concerns about gender equity in the workplace.                                           |           4 |
| Impact on Job Roles in Low Adoption Industries | Sectors with lower AI adoption may struggle with efficiency and innovation, impacting job security and growth.                                  |           4 |
| Ethical Use of AI in Various Industries        | Increasing AI usage necessitates guidelines to ensure ethical application and accountability, particularly in sensitive fields like healthcare. |           5 |
...
| name          | description                                                                                                         |   relevancy |
|:--------------|:--------------------------------------------------------------------------------------------------------------------|------------:|
| Generative AI | AI systems that can generate text, images, or other media based on prompts, increasingly used in workplace tasks.   |           5 |
| ChatGPT       | A specific generative AI tool that assists professionals in various industries with work-related tasks and queries. |           5 |
