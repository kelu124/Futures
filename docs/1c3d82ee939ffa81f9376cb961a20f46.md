...
|:-------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------|------------:|
| AI-Assisted Ransomware Attacks             | The evolution of ransomware due to AI makes it easier for novice criminals to execute large-scale cyber attacks.           |           5 |
| Increased Cyber Criminal Activity          | AI lowers barriers to entry, potentially increasing the number of cyber criminals and frequency of attacks.                |           4 |
| Exploitation of Generative AI by Criminals | Criminals developing AI-driven hacking tools could lead to more sophisticated and widespread cyber threats.                |           5 |
| Impact on National Security                | Increasing ransomware threats pose significant risks to national security and critical infrastructure, such as healthcare. |           5 |
| Development of Criminal AI Models          | The emergence of generative AI models tailored for criminal activity raises serious concerns about future cyber security.  |           4 |
| Vulnerabilities in Essential Services      | Critical services like the NHS and public institutions could face substantial disruptions due to cyber attacks.            |           5 |
| Ransomware as a Business Risk              | Businesses may overlook ransomware threats, treating them casually instead of as critical security issues.                 |           3 |
