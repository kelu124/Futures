...
| name                                      | description                                                                                                                       |   relevancy |
|:------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------|------------:|
| Floating LNG Terminals                    | Mobile infrastructure for liquefied natural gas processing and distribution, enhancing energy supply flexibility and reliability. |           4 |
