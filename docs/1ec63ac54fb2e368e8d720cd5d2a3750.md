...
| name                         | description                                                                                                 |   relevancy |
|:-----------------------------|:------------------------------------------------------------------------------------------------------------|------------:|
| DIY Seismometer              | A compact, custom-built horizontal-pendulum seismometer designed to detect distant earthquakes effectively. |           4 |
| Hall Effect Sensor           | A sensor that detects magnetic fields to sense the position of a pendulum in seismic applications.          |           4 |
| Magnetic Damping System      | A damping mechanism using magnets to reduce oscillation in a pendulum seismometer.                          |           3 |
| Microcontroller Data Logging | Integration of microcontrollers with data logging capabilities for real-time earthquake data capture.       |           4 |
| Neodymium Magnets            | Strong permanent magnets used in damping and sensing for improved seismic readings.                         |           3 |
| Arduino Nano                 | A small microcontroller board used for processing data in the DIY seismometer.                              |           4 |
