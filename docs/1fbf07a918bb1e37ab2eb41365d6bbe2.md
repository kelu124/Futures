...
|:---------------------------------------------------------------------------------------------------------------------|------------:|:---------------------------------|
| Networks of automated accounts using AI to create realistic social media personas for disinformation campaigns.      |           5 | 1fbf07a918bb1e37ab2eb41365d6bbe2 |
| An AI-powered tool that enables large-scale creation and management of social media bot accounts for disinformation. |           5 | 1fbf07a918bb1e37ab2eb41365d6bbe2 |
| An open-source tool used to generate realistic profiles and identities for bot accounts.                             |           4 | 1fbf07a918bb1e37ab2eb41365d6bbe2 |
| Services that allow malicious software and disinformation operations to run undetected from secure data centers.     |           4 | 1fbf07a918bb1e37ab2eb41365d6bbe2 |
| AI chatbots that inadvertently propagate fabricated narratives from state-affiliated sources.                        |           4 | 1fbf07a918bb1e37ab2eb41365d6bbe2 |
| Coordinated efforts using social media to manipulate public opinion and spread propaganda.                           |           5 | 1fbf07a918bb1e37ab2eb41365d6bbe2 |
