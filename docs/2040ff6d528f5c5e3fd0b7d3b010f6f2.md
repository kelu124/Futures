# __Utilisation des cookies et des informations personnelles pour la personnalisation des publicités chez Amazon__, (from page [20240317](https://kghosh.substack.com/p/20240317).)
...
|:------------------------------|:-------------------------------------------------------------------------------------------------------|------------:|
| Privacy Concerns              | The extensive use of personal information for advertising raises significant privacy issues for users. |           5 |
| Data Security Risks           | Storing user data through cookies and third-party access presents potential security vulnerabilities.  |           4 |
| User Consent Misunderstanding | Users may not fully understand consent implications leading to unintentional data sharing.             |           4 |
| Overdependence on Cookies     | Heavy reliance on cookies for user experience may hinder options for users opting for privacy.         |           3 |
| Advertising Algorithm Bias    | Personalized advertising may lead to algorithmic biases affecting what users see and buy.              |           4 |
| Informed Decision Making      | Users lack clarity on how to make informed choices regarding their data preferences.                   |           3 |
