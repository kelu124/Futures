...
| name                 | description                                                                                                      |   relevancy |
|:---------------------|:-----------------------------------------------------------------------------------------------------------------|------------:|
| Generative AI        | AI systems that create content such as music, images, or text based on user inputs or existing datasets.         |           5 |
| Preference Signals   | Mechanisms that allow creators to express acceptable uses of their data and enforce consent in AI models.        |           4 |
| Data Rights Policies | Legal frameworks that address the rights of individuals over their data in the context of AI and copyright.      |           5 |
| Opt-out Registries   | Systems allowing users to withdraw their data from AI training processes and models.                             |           4 |
| AI in Copyright Law  | The evolving legal discourse surrounding copyright as it pertains to AI-generated content and its training data. |           5 |
