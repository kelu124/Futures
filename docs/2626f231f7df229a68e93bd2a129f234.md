...
| name                                            | description                                                                                                                    |   relevancy |
|:------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------|------------:|
| AI-based Early Warning System                   | A system that predicts patient deterioration by analyzing medical records and vital signs, enhancing clinical decision-making. |           5 |
| Chartwatch                                      | An AI tool that monitors patient data in real-time to identify risks and improve outcomes in healthcare settings.              |           5 |
| Machine Learning for Cancer Detection           | Utilizing AI to identify early signs of cancer through data analysis, improving diagnosis accuracy.                            |           4 |
| Voice-based Hypertension Detection              | Using AI to analyze audio input for detecting hypertension, expanding non-invasive diagnostic methods.                         |           4 |
| Brain Pattern Analysis for Concussion Detection | Employing AI to assess brain signals for diagnosing concussions, enhancing injury management.                                  |           4 |
