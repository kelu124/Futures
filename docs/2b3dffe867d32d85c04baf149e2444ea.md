...
| name                                  | description                                                                                                                                                         |   relevancy |
|:--------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Differential Privacy                  | A mathematically rigorous framework for ensuring privacy in data collection and analysis, developed to address electronic data collection concerns.                 |           5 |
| Fairness in Predictive Algorithms     | Formalized safeguards and frameworks to ensure fairness and accuracy in automated predictions and algorithmic decisions.                                            |           5 |
| Gender Shades Project                 | Research highlighting intersectional accuracy disparities in commercial facial recognition systems, focusing on performance for women and dark-skinned individuals. |           5 |
| Model Cards for Model Reporting       | Frameworks aimed at increasing transparency and responsible democratization of machine learning models.                                                             |           5 |
| Machine Learning Emissions Calculator | A tool for estimating the carbon impact of machine learning processes, addressing environmental concerns in AI development.                                         |           4 |
| AI Bill of Rights                     | A framework proposed to protect individuals' rights in relation to AI technologies and their deployment.                                                            |           4 |
| Design Justice                        | Community-led design practices aimed at dismantling structural inequality and advancing collective liberation.                                                      |           4 |
| AI Algorithm Oversight                | Emerging calls for oversight and changes to algorithms used by major tech companies to prioritize user safety and fairness.                                         |           4 |
| Content Moderation Practices          | Research and advocacy around the emotional toll and ethical implications of content moderation in social media.                                                     |           4 |
