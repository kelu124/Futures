...
| name                                        | description                                                                                            |   relevancy |
|:--------------------------------------------|:-------------------------------------------------------------------------------------------------------|------------:|
| ESP32 microchip vulnerability detection     | Research revealing undocumented commands in ESP32 chips enabling impersonation attacks on IoT devices. |           5 |
| BluetoothUSB                                | A free tool enabling comprehensive security audits of Bluetooth devices across any operating system.   |           5 |
| BSAM (Bluetooth Security Audit Methodology) | A systematic methodology for conducting Bluetooth security audits to identify vulnerabilities.         |           5 |
| BlueTrust vulnerability detection           | Identifies Bluetooth devices and infers personal data, highlighting risks of attacks and fraud.        |           5 |
