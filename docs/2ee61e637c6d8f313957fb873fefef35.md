# __Creating a '/now' Page: A Guide to Share Your Current Priorities__, (from page [20240630](https://kghosh.substack.com/p/20240630).)
...
|:---------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Privacy and Information Sharing        | As more people create /now pages, there may be concerns about how personal information is shared publicly and the potential for misuse.     |           4 |
| Sustainability of Platforms            | The reliance on platforms like Bear, which are not backed by investors, raises concerns about their long-term viability and sustainability. |           3 |
| Content Authenticity and Trust         | With the proliferation of /now pages, ensuring the authenticity and trustworthiness of content may become increasingly challenging.         |           4 |
| Digital Distraction and Overcommitment | The ease of creating and sharing /now pages might lead to digital distractions and overcommitment to maintaining an online presence.        |           3 |
| Cultural Homogenization                | As more users adopt similar formats for /now pages, unique personal expressions might diminish in favor of standardized approaches.         |           3 |
