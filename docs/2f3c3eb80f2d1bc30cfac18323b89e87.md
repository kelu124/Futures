# __TSMC Halts Advanced AI Chip Production for Chinese Firms Amid U.S. Restrictions__, (from page [20241117](https://kghosh.substack.com/p/20241117).)
...
|:---------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Impact on AI Development in China            | Restrictions on advanced AI chip production could hinder the growth and innovation of Chinese tech companies like Alibaba and Baidu.         |           5 |
| Global Semiconductor Supply Chain Disruption | US restrictions could lead to significant changes in the global semiconductor supply chain, affecting manufacturers and consumers worldwide. |           4 |
| Increased US-China Tech Rivalry              | Growing tensions around technology and semiconductor production may escalate conflicts and deepen economic divides between the two nations.  |           5 |
| Manufacturing Dependency on TSMC             | Chinese companies may become overly reliant on TSMC for chip production, which could be risky if geopolitical tensions rise further.         |           4 |
| Reduced Innovation Due to Export Controls    | Stringent export controls may stifle innovation in AI technologies both in China and globally, as collaboration becomes strained.            |           5 |
| Regulatory Uncertainty                       | The lack of clear regulations can lead to uncertainties for companies relying on TSMC for production, potentially disrupting business plans. |           3 |
