...
| name                                      | description                                                                                                                            |   relevancy |
|:------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Ontology-powered Knowledge Graphs         | Structured frameworks that represent complex relationships and knowledge in financial domains, facilitating data sharing and insights. |           5 |
