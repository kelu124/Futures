...
| name                               | description                                                                                                                           |   relevancy |
|:-----------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Generative Artificial Intelligence | AI technology that generates content and can enhance cybersecurity measures through predictive analytics and faster response times.   |           5 |
| Secure by Design                   | A software development approach that prioritizes security in design, reducing exploitable vulnerabilities in technology and software. |           5 |
| Cyber Hygiene Campaigns            | Initiatives aimed at promoting cybersecurity awareness and practices among the general public, similar to physical hygiene.           |           4 |
| Corporate Cyber Responsibility     | A concept emphasizing that businesses must actively manage and mitigate their cyber risks as part of good governance.                 |           4 |
| Critical Infrastructure Resilience | Measures and strategies that enhance the resilience of essential services against cybersecurity threats and disruptions.              |           5 |
| End-to-End Encryption              | Advanced encryption methodologies that secure communications over networks, making them resistant to interception.                    |           4 |
