# __Exploring Memorable Prime Numbers: Anecdotes and Discoveries by Mathematicians__, from ([7363.0](https://kghosh.substack.com/p/7363.0).)
...
| name                                 | description                                                                                             |   relevancy |
|:-------------------------------------|:--------------------------------------------------------------------------------------------------------|------------:|
| Memorable Primes                     | Easy-to-remember large prime numbers useful in cryptography, discovered by Shyam Sunder Gupta.          |           4 |
| Great Internet Mersenne Prime Search | A collaborative project using distributed computing power to search for prime numbers.                  |           4 |
| Smarandache Primes                   | A specific type of prime number based on ascending sequences, prompting challenges for discovery.       |           3 |
| Reverse Smarandache Primes           | Primes formed from descending numbers, a new area of exploration initiated by computational biologists. |           3 |
