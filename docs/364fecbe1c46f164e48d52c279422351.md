...
| name                                         | description                                                                                                                                          |   relevancy |
|:---------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Natural Capital Accounting                   | A methodology to quantify ecological materials and services consumed by industries, aiming to integrate environmental costs into economic practices. |           5 |
| Sustainable Industrial Systems               | New industrial frameworks that do not deplete natural capital and instead harmonize with ecological cycles and energy flows.                         |           5 |
| Environmental Impact Assessment Technologies | Innovative tools and methodologies for accurately assessing the environmental impacts of industrial processes and practices.                         |           4 |
| Carbon Footprint Analysis Tools              | Technologies to measure and manage greenhouse gas emissions from industrial activities, promoting accountability and sustainability.                 |           4 |
| Circular Economy Models                      | Economic systems aimed at minimizing waste and making the most of resources by maintaining products, materials, and resources in use.                |           5 |
