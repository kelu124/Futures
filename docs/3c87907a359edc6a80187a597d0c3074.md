...
| name                                | description                                                                                                                                              |   relevancy |
|:------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Frontier AI Models                  | Advanced AI models with flexible uses that may develop unexpected capabilities, raising safety concerns regarding their deployment and potential misuse. |           5 |
