...
| name                                  | description                                                                                                                                      |   relevancy |
|:--------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Artificial Intelligence (AI)          | A category of computationally intensive pattern-matching tools that require high volumes of computation.                                         |           5 |
| Computation-as-a-Service              | A business model shift from data-based billing to selling computational resources for various digital tasks.                                     |           4 |
| Data Centers                          | Facilities that house computer systems and associated components, crucial for processing large amounts of data and computation.                  |           5 |
| Artificial General Intelligence (AGI) | A hypothetical AI that possesses the ability to understand, learn, and apply intelligence across a wide range of tasks, still under development. |           3 |
| Energy-efficient Data Processing      | Advancements in generating electricity and energy management for sustainable operation of data centers.                                          |           5 |
| Embedded AI Technologies              | Integration of AI features into existing software ecosystems, often without clear user need or consent.                                          |           4 |
