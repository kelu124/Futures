...
| name                                        | description                                                                                                   |   relevancy |
|:--------------------------------------------|:--------------------------------------------------------------------------------------------------------------|------------:|
| Prada-Packed Flower Seeds                   | Prada offers flower seeds in branded packaging, promoting environmental engagement through planting.          |           4 |
| Digital 3D Flower Filters                   | Exclusive filters for social media that allow users to create and share digital representations of flowers.   |           5 |
| Interactive Real-Life Marketing Activations | Campaigns that blend physical products with digital experiences, encouraging consumer interaction.            |           4 |
| Intangible to Tangible Campaign Concepts    | Marketing strategies that transform abstract ideas into physical experiences, enhancing emotional connection. |           3 |
