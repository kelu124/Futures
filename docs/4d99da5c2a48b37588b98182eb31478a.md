# __Understanding Digital Liveness: Key Indicators and User Engagement on Social Media__, (from page [20240908](https://kghosh.substack.com/p/20240908).)
...
|:----------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Digital Disconnection                   | The paradox of feeling alive while being disconnected, as digital interactions often lack genuine human connection.                  |           4 |
| Power Hierarchies                       | The potential for social inequality based on platform algorithms that privilege certain users, such as verified accounts.            |           5 |
| FOMO and Dependency                     | Platforms exploiting Fear Of Missing Out (FOMO) to create dependency, affecting mental well-being and social habits.                 |           5 |
| Organic Reach Decline                   | The drastic decline in organic reach on social media, making it harder for users to gain visibility without paid promotion.          |           4 |
| Cultural Shifts due to Digital Features | Changes in language and culture driven by platform features, such as Instagram Stories influencing the use of the term 'selfie.'     |           3 |
| Manipulation of User Engagement         | Platforms manipulating user behaviors through sound design and reminders, raising ethical concerns about user engagement strategies. |           4 |
| Influence of AI on Content Creation     | The implications of AI tools affecting how content is produced and perceived, potentially homogenizing creative expressions.         |           3 |
