...
| name                    | description                                                                                                  |   relevancy |
|:------------------------|:-------------------------------------------------------------------------------------------------------------|------------:|
| Artificial Intelligence | AI systems that analyze and predict human behavior for strategic manipulation in geopolitics.                |           5 |
| Cognitive Warfare       | The use of information to overwhelm and confuse adversaries, inhibiting their decision-making capabilities.  |           5 |
| Information Asymmetry   | Controlling what opponents know and believe to gain a strategic advantage.                                   |           4 |
| Signal Overload         | Sending mixed messages to create confusion among adversaries, disrupting their ability to react effectively. |           4 |
| Strategic Ambiguity     | Maintaining unclear intentions to prevent opponents from forming a solid response.                           |           4 |
| Deep Control            | A modern manipulation technique focusing on being unreadable rather than unpredictable.                      |           5 |
