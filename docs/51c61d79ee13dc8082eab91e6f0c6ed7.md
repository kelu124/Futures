...
| name                                            | description                                                                                                                |   relevancy |
|:------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------|------------:|
| GLP-1 Weight-Loss Drugs                         | Medications like Mounjaro, Ozempic, Wegovy, and Zepbound that help patients curb appetites and lose weight.                |           5 |
| Portion-Aligned Frozen Foods                    | Nestlé's Vital Pursuit line targeting consumers on weight-loss medications with portion-controlled and nutritious options. |           4 |
| Meal Delivery Services for GLP-1 Users          | Services like Daily Harvest offering specialized meal collections for users of GLP-1 weight-loss drugs.                    |           4 |
| Weight Management Membership Programs           | WeightWatchers' new membership program tailored for individuals taking GLP-1 weight-loss medications.                      |           4 |
| Nutritional Supplements for Weight-Loss Support | GNC's support program offering supplements and coaching for people using GLP-1 drugs.                                      |           4 |
