# __Navigating Uncertainty: Roger Spitz's Framework for Systemic Change and Transformation__, (from page [20250323d](https://kghosh.substack.com/p/20250323d).)
...
| name                             | description                                                                                                                |   relevancy |
|:---------------------------------|:---------------------------------------------------------------------------------------------------------------------------|------------:|
| Antifragile Systems              | Systems designed to grow stronger under stress and shocks, moving beyond mere resilience.                                  |           4 |
| Anticipatory Thinking            | A method that prepares for change by scanning for signals and mapping potential future scenarios.                          |           4 |
| Agility in Decision-Making       | The ability to adapt quickly to changes and uncertainties through cognitive flexibility and cross-disciplinary approaches. |           4 |
| Foresight Capabilities           | The skill to explore possible futures and adapt to complexities, informing decision-making and system design.              |           5 |
| Voluntary Carbon Markets         | Market systems designed to promote carbon offsetting through various stakeholders, enhancing environmental governance.     |           3 |
| Transformative Action Frameworks | Models that facilitate systemic change by integrating new thinking and practices to address complex challenges.            |           4 |
