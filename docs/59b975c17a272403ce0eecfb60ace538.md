...
| name                | description                                                                                                                        |   relevancy |
|:--------------------|:-----------------------------------------------------------------------------------------------------------------------------------|------------:|
| DIY Pharmaceuticals | A movement teaching individuals to create homemade versions of expensive medications, bypassing traditional pharmaceutical costs.  |           5 |
| Chemhacktica        | Software that uses machine learning to suggest chemical pathways for molecule synthesis, helping users create their own medicines. |           4 |
| Microlab            | An open-source lab reactor designed for small-molecule organic chemistry, enabling DIY production of medications.                  |           4 |
| Apothecarium        | A drag-and-drop recipe system that provides step-by-step instructions for making specific medications at home.                     |           4 |
