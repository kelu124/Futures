...
| name                                     | description                                                                                                                           |   relevancy |
|:-----------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Nuclear Battery                          | A compact nuclear battery that can produce electricity for 50 years without charging, using miniaturized atomic energy.               |           5 |
| Mass-Produced Nuclear Battery            | The world's first mass-produced nuclear battery, designed for various applications including medical devices and drones.              |           5 |
| Fourth-Generation Diamond Semiconductors | Advanced semiconductor technology that is being developed alongside nuclear battery technology, enhancing performance in electronics. |           4 |
| Micromodular Nuclear Energy Systems      | Small, modular nuclear energy solutions that can be used in diverse applications from aerospace to AI equipment.                      |           4 |
