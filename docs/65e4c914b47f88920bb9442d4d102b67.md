# __Niantic's Vision for a Large Geospatial Model to Revolutionize AR and Spatial Computing__, from ([13055.0](https://kghosh.substack.com/p/13055.0).)
...
| name                                       | description                                                                                                                   |   relevancy |
|:-------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------|------------:|
| Large Geospatial Model (LGM)               | A model using large-scale machine learning to understand and connect scenes globally, enabling advanced spatial intelligence. |           5 |
| Visual Positioning System (VPS)            | A system allowing devices to determine position and orientation using 3D maps built from user-contributed scans.              |           5 |
| Spatial Intelligence                       | The ability for machines to perceive and understand physical spaces, crucial for AR applications and robotics.                |           5 |
| 3D Vision Models                           | Models that interpret and create static and moving images, evolving from 2D to 3D understanding.                              |           4 |
| Neural Maps                                | Maps represented by neural networks that encode location data and provide positioning with centimeter-level accuracy.         |           4 |
| Foundation Models                          | Versatile AI models that interact across different modalities, enhancing understanding of the physical world.                 |           4 |
| AR Glasses                                 | Wearable technology that integrates augmented reality into daily life, relying on spatial computing advancements.             |           5 |
| Geospatial Intelligence                    | The capability of understanding and manipulating 3D representations of the world for enhanced AR experiences.                 |           4 |
| Camera Positioning Neural Network (MicKey) | A neural network that positions camera views relative to each other, even under drastic viewpoint changes.                    |           3 |
