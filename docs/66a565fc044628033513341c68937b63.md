# __Analyse des impacts du numérique sur la société et l'environnement dans "L'empire des algorithmes"__, (from page [20220904](https://kghosh.substack.com/p/20220904).)
...
|:-----------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|------------:|
| Transformation sociale due aux algorithmes     | Les algorithmes modifient radicalement les rapports de pouvoir, entraînant des bouleversements sociaux.              |           4 |
| Obsolescence de l'activité humaine             | La puissance des algorithmes risque de rendre obsolètes certaines activités humaines essentielles.                   |           5 |
| Difficulté d'établir la vérité                 | Le numérique remet en question l'établissement de la vérité et son organisation politique.                           |           5 |
| Impact environnemental et adaptation sociétale | L'interaction entre la révolution numérique et les changements environnementaux pose des défis majeurs à la société. |           4 |
| Souveraineté numérique                         | La domination des algorithmes et des plateformes remet en question la souveraineté des nations.                      |           4 |
| Gouvernance de l'écosystème menacée            | Le contrôle numérique peut entraver la gouvernance efficace des systèmes environnementaux.                           |           5 |
