# __Security Vulnerability in Subaru's STARLINK Service Exposed: Unauthorized Vehicle Access and Customer Information Leaked__, (from page [20250209](https://kghosh.substack.com/p/20250209).)
...
| name                                               | description                                                                                                |   relevancy |
|:---------------------------------------------------|:-----------------------------------------------------------------------------------------------------------|------------:|
| Connected Vehicle Technology                       | Technology that enables vehicles to connect to the internet for remote control and data access.            |           5 |
| Telematics Systems                                 | Systems that monitor vehicle location and performance through sensors and GPS, allowing for remote access. |           4 |
| Vulnerability Exploitation in IoT Devices          | Techniques used to exploit vulnerabilities in Internet of Things devices, including connected cars.        |           4 |
| Remote Vehicle Control                             | The ability to start, stop, lock, unlock, and track vehicles remotely via internet connectivity.           |           5 |
| Data Privacy in Automotive Systems                 | Concerns regarding the security and privacy of personal data collected by connected vehicle systems.       |           5 |
| 2-Factor Authentication (2FA) Bypassing Techniques | Methods to bypass two-factor authentication in applications, raising security concerns.                    |           3 |
