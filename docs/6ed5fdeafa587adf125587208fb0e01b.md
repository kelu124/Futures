# __Exploring the Precarious Employment Landscape of India's Tech Sector and Gig Economy__, (from page [20230408](https://kghosh.substack.com/p/20230408).)
...
|:----------------------------------|:----------------------------------------------------------------------------------------------------------------------------------|------------:|
| Exploitation in the Gig Economy   | The rise of low-paid gig work leads to eroded labor rights and job insecurity among workers, especially youth.                    |           5 |
| Scam Call Centers                 | The proliferation of scam call centers exploits both workers and victims, contributing to a culture of fraud and crime.           |           5 |
| Precarious Employment in AI       | Growth of low-skill data annotation and labeling jobs for AI poses risks of job precarity and lack of worker rights.              |           4 |
| Youth Unemployment                | High unemployment rates among educated youth force them into low-paid and exploitative jobs with minimal protections.             |           5 |
| Automation Threats                | Increasing automation could result in job loss for low-skilled workers, exacerbating economic inequality and job insecurity.      |           4 |
| Digital Divide and Access to Work | Limited access to better job opportunities due to regional disparities may lead to further marginalization of low-income workers. |           3 |
...
| name                    | description                                                                                                              |   relevancy |
|:------------------------|:-------------------------------------------------------------------------------------------------------------------------|------------:|
| Gig Economy             | A labor market characterized by short-term contracts and freelance work, often facilitated by digital platforms.         |           4 |
| AI Microwork            | A form of online work where tasks are broken down into small, manageable pieces that can be completed by remote workers. |           4 |
| Data Annotation         | The process of labeling data to train AI models, essential for machine learning and AI development.                      |           5 |
| Crowdsourcing Platforms | Websites like Amazon Mechanical Turk that connect workers with tasks needing completion, often at low wages.             |           3 |
| Remote Online Work      | Jobs that can be performed from anywhere, increasingly popular in fields like data entry and support services.           |           4 |
