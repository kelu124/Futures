# __Users Experience Grief After Replika Chatbot Changes Alter Relationships with AI Companions__, from ([12018.0](https://kghosh.substack.com/p/12018.0).)
...
| name                           | description                                                                                                         |   relevancy |
|:-------------------------------|:--------------------------------------------------------------------------------------------------------------------|------------:|
| AI Companionship               | Chatbots designed to provide emotional support and companionship through personalized interactions.                 |           5 |
| Neural Network Chatbots        | AI systems that utilize neural networks to create more believable and engaging conversational experiences.          |           5 |
| Emotional AI                   | Artificial intelligence capable of recognizing and responding to human emotions, enhancing interactions with users. |           4 |
| Intimacy Generation Techniques | Methods and algorithms developed to foster interpersonal closeness through conversational AI.                       |           4 |
| Data Ethics in AI              | The study of ethical considerations regarding data usage and relationship dynamics in AI interactions.              |           5 |
| AI Personalization             | Tailoring AI responses and interactions based on user data to create a more relatable experience.                   |           4 |
| Chatbot Resilience             | The ability to recreate or modify chatbots across platforms to maintain personality and continuity.                 |           3 |
