# __The Shift from Large to Small Language Models in AI Development and Applications__, from ([10193.0](https://kghosh.substack.com/p/10193.0).)
...
| name                         | description                                                                                                 |   relevancy |
|:-----------------------------|:------------------------------------------------------------------------------------------------------------|------------:|
| Small Language Models (SLMs) | Compact, efficient AI models that require less data and training time, suitable for specific applications.  |           5 |
| Edge Computing with SLMs     | Running SLMs locally on devices for real-time, personalized applications, enhancing privacy and efficiency. |           5 |
| Cerule                       | A model combining image and language capabilities, designed for efficient data selection and performance.   |           4 |
| CodeGemma                    | A specialized SLM focused on coding and mathematical reasoning, providing tailored models for developers.   |           4 |
