# __Understanding Cross Fork Object Reference Vulnerabilities in GitHub and Their Implications for Data Security__, from ([8990.0](https://kghosh.substack.com/p/8990.0).)
