# __Analysis Reveals Cybertruck's Fatality Rate Exceeds That of Ford Pinto__, (from page [20250302](https://kghosh.substack.com/p/20250302).)
...
|:-----------------------------------|:-------------------------------------------------------------------------------------------------------|------------:|
| Cybertruck Safety Risks            | High fatality rate in Cybertruck compared to other vehicles raises significant safety concerns.        |           5 |
| Questionable Crash Testing         | Lack of comprehensive crash test results from NHTSA and Insurance Institute poses risks for consumers. |           4 |
| Regulatory Oversight               | Potential inadequacies in regulatory oversight could lead to unsafe vehicles being on the road.        |           5 |
| Reliance on Manufacturer Claims    | Over-reliance on manufacturers’ safety claims without independent verification can mislead consumers.  |           4 |
| Crisis Response and Accountability | Concerns over the accountability of manufacturers in case of fatal incidents involving their vehicles. |           4 |
| Data Transparency Issues           | Limited transparency in sales and safety data from Tesla raises concerns about public safety.          |           5 |
