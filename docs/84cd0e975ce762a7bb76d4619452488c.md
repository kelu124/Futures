...
| name                            | description                                                                                                                                      |   relevancy |
|:--------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Carbon Coin                     | A complementary currency issued in proportion to the mass of carbon mitigated, aimed at addressing climate change.                               |           5 |
| Carbon Quantitative Easing      | A monetary policy proposal to combat climate change by issuing currency based on carbon reduction efforts.                                       |           5 |
| Geoengineering                  | Technologies aimed at deliberately altering the Earth's climate system to mitigate climate change effects, such as glacier meltwater management. |           4 |
| Carbon Farming                  | Agricultural practices aimed at capturing and storing atmospheric carbon dioxide through soil and vegetation management.                         |           4 |
| Sail-Driven Container Ships     | Cargo ships that utilize sail technology to reduce fossil fuel consumption, promoting sustainable shipping practices.                            |           4 |
| Airships for Personal Transport | Using lighter-than-air craft for personal travel, potentially reducing carbon emissions compared to conventional vehicles.                       |           4 |
