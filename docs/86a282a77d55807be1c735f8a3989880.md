...
| name              | description                                                                                                      |   relevancy |
|:------------------|:-----------------------------------------------------------------------------------------------------------------|------------:|
| Mermaid Diagrams  | A tool for generating diagrams and flowcharts using text descriptions, enhancing visualization in documentation. |           4 |
| Gantt Charts      | A project management tool that illustrates a project schedule, showing the start and finish dates of tasks.      |           4 |
| Sequence Diagrams | An interaction diagram that shows the order of processes and how they operate with one another.                  |           4 |
| Flowcharts        | Diagrams that represent workflows or processes, showing steps as boxes connected by arrows.                      |           4 |
