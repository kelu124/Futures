...
| name                              | description                                                                                                                                        |   relevancy |
|:----------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Malware Development               | The creation of custom malware to sabotage corporate systems, showcasing advanced programming skills and a deep understanding of network security. |           4 |
| Kill Switch Technology            | A mechanism that locks users out of systems based on specific conditions, indicating the potential for abuse in IT management.                     |           5 |
| Privilege Escalation Tools        | Tools or methods used to gain higher access rights within a computer system, raising security concerns in corporate environments.                  |           4 |
| Data Deletion Techniques          | Methods for permanently deleting sensitive data, highlighting risks related to information security and employee exits.                            |           3 |
| Destruction Code Naming Practices | Creative naming of malicious code, indicating a trend in personalizing malware for psychological impact.                                           |           2 |
