...
| name                           | description                                                                                                                |   relevancy |
|:-------------------------------|:---------------------------------------------------------------------------------------------------------------------------|------------:|
| Digitisation                   | The transition to digital technologies aimed at increasing productivity and efficiency in various sectors.                 |           5 |
| Remote Work Technologies       | Tools and platforms that facilitate working from home, enhancing work-life balance and potentially productivity.           |           4 |
| AI and Machine Learning        | Technologies that automate processes and improve decision-making through data analysis, anticipated to boost productivity. |           5 |
| Robotics                       | The use of robots in various industries, which was expected to rise but has stagnated post-pandemic.                       |           3 |
| Intellectual Property Products | Spending on R&D and new innovations that contribute to productivity, though currently underperforming.                     |           4 |
