...
| name                                       | description                                                                                                   |   relevancy |
|:-------------------------------------------|:--------------------------------------------------------------------------------------------------------------|------------:|
| E-books                                    | Digital versions of books that can be read on electronic devices, allowing for easier access and portability. |           4 |
| Audiobooks                                 | Books that are narrated and can be listened to, providing an alternative to traditional reading methods.      |           4 |
| Specialised reading devices (e.g., Kindle) | Dedicated devices for reading e-books, often featuring e-ink technology for better readability.               |           3 |
| Mobile reading applications                | Apps designed for reading e-books on smartphones, increasing accessibility of digital literature.             |           4 |
| Digital libraries                          | Online platforms that allow users to borrow or read e-books and audiobooks digitally.                         |           5 |
