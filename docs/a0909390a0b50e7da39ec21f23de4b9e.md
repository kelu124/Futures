...
| name                            | description                                                                                                              |   relevancy |
|:--------------------------------|:-------------------------------------------------------------------------------------------------------------------------|------------:|
| Information Extraction Pipeline | A structured approach to extract information from unstructured data using LLMs and graph representations.                |           5 |
| Knowledge Graphs                | Graph representations of information that combine structured and unstructured data for analytics and question-answering. |           5 |
| OpenAI Functions                | APIs that utilize LLMs to output structured JSON data for easier information extraction.                                 |           4 |
| LangChain                       | A framework for building applications with LLMs, enabling seamless integration with databases like Neo4j.                |           4 |
| Entity Disambiguation Models    | Techniques to accurately identify and distinguish entities to ensure consistency in data representation.                 |           4 |
| RAG Applications                | Retrieval-Augmented Generation applications that combine retrieval of structured data with generative models.            |           4 |
| Cypher Query Language           | A structured query language for graph databases, enabling user-friendly interactions with knowledge graphs.              |           3 |
