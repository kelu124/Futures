...
| name                         | description                                                                                                |   relevancy |
|:-----------------------------|:-----------------------------------------------------------------------------------------------------------|------------:|
| Regenerative Design          | A design approach that seeks to restore and enhance planetary health through harmony with natural systems. |           5 |
| Nature-led Design            | Design methodology that enhances and emulates the processes and systems found in nature.                   |           4 |
| Systemic Resource Management | Management of materials and resources aimed at restoring and replenishing natural ecosystems.              |           4 |
| Equitable Design Principles  | Design philosophies that promote inclusivity and social justice through collective change and co-creation. |           4 |
