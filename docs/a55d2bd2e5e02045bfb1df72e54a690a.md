...
| name                                            | description                                                                                                              |   relevancy |
|:------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------|------------:|
| General-Purpose AI Models                       | AI systems designed to perform a wide range of tasks without being limited to a specific domain, governed by the AI Act. |           5 |
| AI Governance Ecosystems                        | Frameworks and structures aimed at managing AI risks and ensuring compliance with regulatory guidelines.                 |           4 |
| Systemic Risk Assessment Tools                  | Tools and methodologies for evaluating and mitigating systemic risks associated with advanced AI models.                 |           5 |
| Transparency and Copyright Obligations for AI   | Requirements for AI providers to ensure transparency in operations and adherence to copyright laws.                      |           4 |
| Cybersecurity Measures for AI Models            | Protocols and practices to protect AI systems from security threats and vulnerabilities.                                 |           5 |
| Key Performance Indicators (KPIs) for AI Models | Metrics to evaluate the performance and compliance of AI models with established guidelines.                             |           3 |
