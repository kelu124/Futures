# __Réduisez votre utilisation des réseaux sociaux avec l'application "one sec".__, (from page [20240616](https://kghosh.substack.com/p/20240616).)
...
|:----------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------|------------:|
| Psychological Dependency on Social Media      | High reliance on social media leads to psychological distress, anxiety, and depression, exacerbating mental health issues. |           5 |
...
| name                             | description                                                                                                                       |   relevancy |
|:---------------------------------|:----------------------------------------------------------------------------------------------------------------------------------|------------:|
| one sec                          | A concentration app that reduces unconscious social media usage by forcing users to pause and reflect before opening apps.        |           5 |
| Habit-breaking applications      | Apps designed to alter user habits by implementing delays and prompting intention setting before engaging with social media.      |           4 |
| Data privacy-focused apps        | Applications that prioritize user data privacy by not selling or analyzing personal data, ensuring only the user has access.      |           5 |
| Mental health intervention tools | Technologies aimed at mitigating psychological distress associated with high social media usage through behavioral modifications. |           4 |
