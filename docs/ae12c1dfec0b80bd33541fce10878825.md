...
| name                                             | description                                                                                                              |   relevancy |
|:-------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------|------------:|
| SVOD (Subscription Video on Demand) services     | Platforms like Netflix, Hulu, and Prime Video that offer films for home viewing, impacting theatrical attendance.        |           5 |
| AYCE (All You Can Eat) subscription models       | Subscription services that allow moviegoers to watch multiple films for a flat fee, potentially revitalizing attendance. |           4 |
| Premium movie tickets with added benefits        | Ticketing options that include perks such as discounts or early access to films, enhancing the moviegoing experience.    |           4 |
| Relaxed decorum showings                         | Special screenings allowing more freedom for audience interaction, such as dancing or recording, to attract viewers.     |           3 |
| Hybrid release models (theatrical and streaming) | Simultaneous release of films in theaters and on streaming platforms, altering traditional viewing habits.               |           4 |
