# __Sondage révèle un soutien croissant des Français pour limiter les vols aériens par personne__, (from page [20231126](https://kghosh.substack.com/p/20231126).)
...
| name                   | description                                                                                                                                              |   relevancy |
|:-----------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Quota de Vols          | Proposition de limiter les voyages en avion à 4 vols par personne dans une vie pour réduire l'empreinte carbone.                                         |           4 |
| Transports Alternatifs | Tendance des Français à se tourner vers d'autres modes de transport en réponse à des préoccupations environnementales et économiques.                    |           4 |
| Data Intelligence      | Utilisation avancée de l'analyse de données pour comprendre les comportements et opinions des consommateurs, en particulier dans le contexte post-COVID. |           5 |
| Marketing Mix Modeling | Méthode d'analyse du marketing pour prédire les effets et les réponses des campagnes publicitaires, essentielle pour les entreprises modernes.           |           5 |
