# __Using Prompt Injection to Enhance Your Resume for AI Screening Systems__, (from page [20231119](https://kghosh.substack.com/p/20231119).)
...
|:--------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Manipulation of AI Screening Systems        | Job seekers leveraging invisible text injections to manipulate AI algorithms, leading to unfair advantages in hiring processes.      |           4 |
| Erosion of Trust in Hiring Processes        | Widespread use of prompt injection tactics could undermine trust in AI-driven resume screening and vetting systems.                  |           5 |
| Security Vulnerabilities in AI Systems      | Manipulating AI models poses security risks, especially if these systems control sensitive or significant decision-making processes. |           5 |
| Encouragement of Dishonesty in Applications | Tools that enable deceptive practices may encourage candidates to misrepresent their qualifications or experiences.                  |           4 |
| Impact on Algorithmic Integrity             | The ability to bypass AI analysis raises concerns about the reliability and integrity of algorithm-driven evaluations.               |           5 |
| Misalignment of Talent Acquisition          | Relying on manipulated inputs could lead to mismatches between candidates' actual skills and job requirements.                       |           4 |
| Vulnerability to AI Misuse                  | Tools designed for prompt injection can be misused in other contexts, extending risks beyond hiring processes.                       |           3 |
...
|:--------------------------------------------------------------------------------------------------------------------------------------------|------------:|:---------------------------------|
| A technique to manipulate AI language models by injecting invisible text into PDFs, enhancing candidate visibility in automated screenings. |           4 | b2d7d8acca09603a27029a23e3690580 |
| Inserting unseen text in documents that is detectable by AI but not visible to humans, influencing AI processing outcomes.                  |           4 | b2d7d8acca09603a27029a23e3690580 |
| Tools like Quillbot that utilize AI to summarize content, often employing different mechanisms than large language models.                  |           3 | b2d7d8acca09603a27029a23e3690580 |
| AI-driven systems for resume screening, which rely on language models or keyword extraction to assess candidates.                           |           5 | b2d7d8acca09603a27029a23e3690580 |
| Risks associated with manipulating AI systems through prompt injections, highlighting the need for protective measures.                     |           5 | b2d7d8acca09603a27029a23e3690580 |
