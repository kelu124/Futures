...
|:------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Safety and Accountability of Agentic AI   | Concerns about ensuring agentic AI systems operate safely and are held accountable for their actions as they pursue complex goals with limited supervision. |           5 |
| Governance Frameworks for AI              | The need for new governance frameworks to address the indirect impacts and ethical considerations of wide-scale adoption of agentic AI systems.             |           4 |
| Complexity of Implementing Best Practices | Uncertainties and questions regarding how to effectively implement safety best practices for agentic AI systems remain unaddressed.                         |           4 |
| Potential for Harm from Agentic AI        | The potential risks of harm associated with the deployment of agentic AI systems if not integrated responsibly into society.                                |           5 |
| Responsibility In the AI Lifecycle        | The necessity of defining baseline responsibilities among various stakeholders involved in the agentic AI system life-cycle to mitigate risks.              |           4 |
