...
| name                                 | description                                                                                                                                         |   relevancy |
|:-------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| IntelligentGraph                     | A knowledge graph with embedded analytics that enhances data analysis capabilities by integrating calculations directly within the graph structure. |           5 |
| Industrial Internet of Things (IIoT) | A network connecting industrial measurements and processes to improve data analysis and operational monitoring.                                     |           5 |
| Embedded Analytics                   | Integrating analytics directly into data storage structures like knowledge graphs, allowing real-time data analysis without data export.            |           4 |
| RDF4J                                | A framework for handling RDF data with capabilities for integrating advanced analytics and scripting functionalities.                               |           4 |
| PathQL                               | An expressive query language designed for advanced graph navigation and data retrieval within IntelligentGraph.                                     |           3 |
