...
| name                          | description                                                                                                                   |   relevancy |
|:------------------------------|:------------------------------------------------------------------------------------------------------------------------------|------------:|
| Generative AI                 | A type of artificial intelligence that can generate content, such as text, images, and more, based on input data.             |           5 |
| AI in Business Strategy       | The integration of artificial intelligence into business strategies to improve product quality and operational efficiency.    |           4 |
| Upskilling in AI              | Training employees to develop new skills related to AI technologies, particularly generative AI.                              |           4 |
| Hybrid Cloud with AI          | Combining hybrid cloud solutions with generative AI to enhance data management and operational capabilities.                  |           4 |
| AI-Driven Cost Savings        | Utilizing AI technologies to achieve significant cost savings in various business operations.                                 |           4 |
| AI Experimentation and Pilots | Conducting small-scale experiments with AI technologies to explore their potential benefits before full-scale implementation. |           4 |
