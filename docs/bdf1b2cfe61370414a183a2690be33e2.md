# __Exploring stlite: A Serverless Approach to Running Streamlit Apps in Your Browser__, from ([2020.0](https://kghosh.substack.com/p/2020.0).)
...
| name                | description                                                                                                               |   relevancy |
|:--------------------|:--------------------------------------------------------------------------------------------------------------------------|------------:|
| stlite              | A browser-based implementation of Streamlit, allowing apps to run without server-based code.                              |           4 |
| Pyodide             | A Python interpreter ported to Web Assembly, enabling Python code execution directly in web browsers.                     |           5 |
| Web Assembly (WASM) | A binary instruction format for a stack-based virtual machine, allowing code to run in web browsers at near-native speed. |           5 |
