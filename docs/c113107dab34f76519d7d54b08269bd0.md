# __Understanding Homomorphic Encryption and Its Role in iOS 18's Privacy Features__, from ([20280.0](https://kghosh.substack.com/p/20280.0).)
...
| name                                  | description                                                                                                                     |   relevancy |
|:--------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------|------------:|
| Homomorphic Encryption                | A form of encryption allowing computations on ciphertexts, enabling data processing without exposing sensitive information.     |           5 |
| Fully Homomorphic Encryption (FHE)    | An advanced form of homomorphic encryption that allows unlimited operations on encrypted data without decryption.               |           5 |
| Somewhat Homomorphic Encryption (SHE) | A restricted version of homomorphic encryption that supports a limited number of operations on encrypted data.                  |           4 |
| Private Cloud Compute                 | A method to run complex AI workloads in isolated environments, ensuring privacy and security for data computations.             |           4 |
| Lattice-based Encryption              | A type of encryption based on lattice problems, considered secure against quantum attacks and useful in homomorphic encryption. |           4 |
| Differential Privacy                  | A technique used to ensure that individual data cannot be identified within a dataset, enhancing privacy in data analysis.      |           4 |
