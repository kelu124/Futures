...
|:--------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Globalization Risks       | The rapid globalization driven by container shipping may lead to economic disparities and vulnerabilities in local economies.                        |           4 |
| Supply Chain Security     | Increased reliance on container shipping creates challenges in ensuring security against terrorism and other threats within shipping systems.        |           5 |
| Labor Market Displacement | The shift to automated container shipping may displace traditional dock workers, affecting livelihoods within impacted communities.                  |           4 |
| Infrastructure Strain     | As container shipping grows, existing port infrastructures may become overwhelmed, leading to inefficiencies and logistical breakdowns.              |           3 |
| Environmental Impact      | The expansion of container shipping can lead to environmental degradation, including pollution and increased carbon emissions from shipping traffic. |           5 |
| Technological Dependency  | Overreliance on technology for container shipping logistics may lead to systemic failures if systems malfunction or are compromised.                 |           4 |
| Economic Consolidation    | The consolidation of shipping companies may reduce competition, leading to higher costs and fewer choices for consumers and businesses.              |           3 |
...
| name                              | description                                                                                                                                       |   relevancy |
|:----------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Containerization                  | A system of intermodal freight transport using standardized containers, revolutionizing global trade and supply chain efficiency.                 |           5 |
| Operations Research in Shipping   | The application of mathematical methods to optimize shipping operations and logistics, significantly improving efficiency and cost-effectiveness. |           4 |
| Automated Port Logistics          | Use of automation and technology for managing container handling and port operations, enhancing speed and reliability of shipping.                |           5 |
| Intermodal Transportation Systems | Integrated transport systems that utilize multiple modes of transport (ship, rail, truck) for efficient goods movement.                           |           4 |
| Real-time Supply Chain Management | Advanced systems for managing and coordinating supply chains in real-time, driven by the efficiency of container shipping.                        |           5 |
