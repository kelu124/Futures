...
|:--------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Financial Precariousness of Artists   | The increasing income disadvantage for artists, resulting in financial instability and diminished opportunities in the arts.          |           4 |
...
| name                        | description                                                                                  |   relevancy |
|:----------------------------|:---------------------------------------------------------------------------------------------|------------:|
| AI Music Generation         | Using AI to create music by licensing the voices of deceased musicians for new compositions. |           5 |
| Immersive Music Therapy     | Utilizing longer music tracks (9-13 minutes) for improved mental health and relaxation.      |           4 |
| Circadian Rhythm Treatments | Innovative medical treatments that leverage body rhythms for mental health improvement.      |           4 |
| Project Mercury             | A Google initiative to manipulate search queries for increased advertising revenue.          |           3 |
