...
| name                                  | description                                                                                                     |   relevancy |
|:--------------------------------------|:----------------------------------------------------------------------------------------------------------------|------------:|
| Minimal Cell Simulation               | Simulating the simplest cell using TypeScript to understand cell functions like DNA replication and metabolism. |           4 |
| Kinetic Modeling                      | Using kinetic parameters to model molecular interactions and reactions in a minimal cell.                       |           5 |
| Chemical Master Equation (CME)        | A method to simulate stochastic biological processes such as DNA transcription and protein synthesis.           |           4 |
| Ordinary Differential Equations (ODE) | A deterministic method to calculate metabolic reactions in biological systems.                                  |           4 |
| Web Assembly (WASM)                   | Compiling code for fast execution in the browser, enhancing performance of simulations.                         |           5 |
| Molecular Dynamics Simulation         | Future technology aiming to simulate each atom in a cell for closer realism in biological research.             |           5 |
