...
|:------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------|------------:|
| Environmental Impact of Construction      | The immense environmental cost of constructing new metro lines, despite future carbon savings from public transport.          |           4 |
| Cost Overruns and Budget Issues           | The project has exceeded its budget significantly, raising concerns over financial mismanagement and economic sustainability. |           5 |
| Worker Safety on Construction Sites       | Five fatal accidents at construction sites highlight potential negligence in ensuring worker safety practices.                |           5 |
| Community Resistance and Gentrification   | Fear of increased violence and social unrest due to improved access to inner-city Paris could alienate existing residents.    |           4 |
| Political Influence on Project Outcomes   | The process of decision-making may be overly political, leading to biased outcomes favoring certain neighborhoods.            |           3 |
| Accessibility and Equity of Service       | Concerns regarding which neighborhoods are prioritized for service and how it affects socio-economic dynamics.                |           4 |
| Impact on Local Culture and Identity      | Transformation of metro stations into artistic spaces may lead to shifts in community identity and cultural relevance.        |           3 |
| Public Perception and Trust in Government | Growing public skepticism towards the government’s handling of the project could undermine trust in future initiatives.       |           4 |
...
| name                                | description                                                                                                                        |   relevancy |
|:------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------|------------:|
| Grand Paris Express (GPE)           | A major civil engineering project expanding the metro system in Paris to enhance connectivity and sustainability.                  |           5 |
| Subterranean Architecture           | Innovative design approaches for underground infrastructure, maximizing natural light and space utilization.                       |           4 |
| Integrated Public Transport Systems | A seamless connection between different modes of transport (metro, bus, train) to reduce car dependency and improve accessibility. |           5 |
| Culturally Relevant Public Spaces   | Designing metro stations as public art galleries to enhance community identity and engagement.                                     |           4 |
| Sustainable Urban Mobility          | Transport solutions aimed at reducing environmental impact and promoting public transportation over cars.                          |           5 |
