...
|:-------------------------------------------------------------------------------------------------------------------------|------------:|:---------------------------------|
| A system for capturing and analyzing AIS messages to understand cargo ship contents and movements.                       |           4 | d0bfdc87787c434e20186084e488725 |
| A maritime communication system that broadcasts ship position, speed, and metadata for safety and situational awareness. |           5 | d0bfdc87787c434e20186084e488725 |
| A software-defined radio technology used to receive and decode AIS transmissions from ships.                             |           4 | d0bfdc87787c434e20186084e488725 |
| An API that provides access to public datasets, including bills of lading for analyzing cargo contents.                  |           4 | d0bfdc87787c434e20186084e488725 |
| A system that contains structured documentation of imported goods, crucial for understanding global trade logistics.     |           5 | d0bfdc87787c434e20186084e488725 |
