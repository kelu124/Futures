...
| name                        | description                                                                                                         |   relevancy |
|:----------------------------|:--------------------------------------------------------------------------------------------------------------------|------------:|
| Micronuclear Batteries      | Small nuclear batteries harnessing energy from radioactive isotopes for long-lasting power in various applications. |           5 |
| Alphas-decay Batteries      | Batteries utilizing alpha decay of radioisotopes for efficient energy conversion and power generation.              |           4 |
| Betavoltaic Devices         | Devices that convert beta particle emissions into electrical power, suitable for commercial use.                    |           4 |
| Carbon-14 Diamond Batteries | Batteries created from carbon-14 isotopes in diamond structures, offering long lifespan and intermittent power.     |           5 |
| Tritium-powered Sensors     | Sensors powered by tritium chips for monitoring applications in extreme environments and space exploration.         |           5 |
