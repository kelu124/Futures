# __Evaluating GPT Startups: The Three-Hills Model for Long-Term Success__, (from page [20230521](https://kghosh.substack.com/p/20230521).)
...
|:------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Displacement of Traditional Jobs    | Many jobs may become obsolete or significantly altered due to the rapid adoption of GPT technologies, leading to potential unemployment.                            |           5 |
...
| name                                | description                                                                                                                                                               |   relevancy |
|:------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| GPT Technologies                    | Technologies based on Generative Pre-trained Transformers that enhance productivity in various fields by assisting users in completing tasks faster and more efficiently. |           5 |
| Collaborative GPT Platforms         | Platforms that enhance collaborative efforts among multiple users while integrating GPT functionalities for reviews, commenting, and knowledge sharing.                   |           4 |
| Gated Knowledge/Data Integration    | Applications that leverage proprietary or non-public data to improve outputs of GPT models for specific industries or tasks.                                              |           4 |
| Edge Computing for GPT Applications | Localized GPT solutions that operate offline, ensuring user privacy and security while providing assistance in various tasks.                                             |           4 |
| Assisted Engineering Tools          | Tools that utilize GPT functionalities to streamline and enhance hardware development processes, integrating domain-specific data and collaborative features.             |           5 |
