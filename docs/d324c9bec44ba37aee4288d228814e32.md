# __Meta to Block News Content for Canadian Users Following Bill C-18's Passage__, (from page [20230701](https://kghosh.substack.com/p/20230701).)
...
| name                                                      | description                                                                                                                        |   relevancy |
|:----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------|------------:|
| Online News Act (Bill C-18)                               | A Canadian legislation aimed at regulating payments from tech companies to news outlets for content usage.                         |           5 |
| Mandatory Bargaining Process                              | A process allowing news businesses to negotiate compensation with tech companies through arbitration if agreements aren't reached. |           4 |
| Digital Content Compensation Framework                    | A framework established to ensure fair compensation for news content used by digital platforms.                                    |           4 |
| Regulatory and Implementation Processes for Digital Media | Processes to guide the application and compliance of the Online News Act by tech companies.                                        |           3 |
