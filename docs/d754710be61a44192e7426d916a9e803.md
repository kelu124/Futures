...
| name   | description                                                                                                                                                |   relevancy |
|:-------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| DocLLM | A lightweight language model designed for understanding complex document layouts without costly image encoders, enhancing efficiency in document handling. |           5 |
