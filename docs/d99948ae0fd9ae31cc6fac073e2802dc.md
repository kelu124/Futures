...
| name             | description                                                                                             |   relevancy |
|:-----------------|:--------------------------------------------------------------------------------------------------------|------------:|
| UEFI Bootkit     | A new type of bootkit that targets the UEFI firmware, specifically designed for Linux systems.          |           4 |
| Bootkitty        | A proof-of-concept UEFI bootkit for Linux, indicating potential future threats in UEFI security.        |           3 |
| UEFI Secure Boot | A security feature that uses cryptographic signatures to ensure trusted software during system startup. |           5 |
