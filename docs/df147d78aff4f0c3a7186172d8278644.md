# __The Impact of Generative AI on Freelance and Outsourced Workers Worldwide__, (from page [20230114](https://kghosh.substack.com/p/20230114).)
...
|:--------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Competitive Threat from Generative AI | Freelancers face increased competition from AI-generated content, raising concerns over job security and income stability for creative workers.           |           5 |
| Job Displacement in Outsourcing       | The rise of AI tools threatens to displace outsourced workers, reducing demand for their skills and worsening financial precarity.                        |           5 |
| Exploitation in Gig Economy           | Freelancers, particularly in the Global South, may face increased exploitation as businesses seek cheaper, AI-generated alternatives, driving wages down. |           4 |
| Impact on Customer Service Industry   | AI's integration in BPO and customer service may lead to significant layoffs, particularly affecting lower-skilled, front-line workers—often women.       |           5 |
| Quality vs. Quantity in Creative Work | The focus on AI-generated art may dilute the value of original artistry, with clients prioritizing speed and cost over quality and creativity.            |           4 |
| Mental Health and Financial Security  | Anxiety over job security and the threat of automation can negatively impact the mental health and financial well-being of freelance workers.             |           4 |
| Regulatory Gaps in the Gig sector     | The lack of regulations in the gig economy leaves workers vulnerable to sudden market shifts, exploitation, and reduced protections.                      |           4 |
| Evolving Skill Requirements           | The demand for new skills, such as prompt engineering, creates pressure on workers to continually adapt to an evolving job market.                        |           4 |
| Dependence on Technology              | As freelancers increasingly rely on AI tools, they may face challenges in maintaining creative agency and the quality of their work.                      |           4 |
...
| name                               | description                                                                                                     |   relevancy |
|:-----------------------------------|:----------------------------------------------------------------------------------------------------------------|------------:|
| Generative AI                      | AI systems capable of creating content such as images, text, and music based on prompts.                        |           5 |
| AI image generators                | Tools like Midjourney, Stable Diffusion, and Dall-E that produce images from textual descriptions.              |           5 |
| AI-powered writing assistants      | Applications like ChatGPT that help with content creation, editing, and research.                               |           5 |
| Conversational AI tools            | AI systems designed to handle customer service inquiries and improve operational efficiency.                    |           4 |
| Generative fill in design software | Photoshop feature that allows users to enhance images using text prompts for modifications.                     |           4 |
| AI implementation services         | Services that help businesses integrate AI solutions into their operations, such as app development using APIs. |           4 |
| AI in e-commerce                   | Utilization of generative AI to create promotional materials and product imagery efficiently.                   |           4 |
| Prompt engineering                 | The skill of crafting effective prompts to guide AI tools towards desired outputs.                              |           3 |
| Micro work platforms               | Online platforms facilitating small tasks requiring human input for AI training and data validation.            |           3 |
