...
| name                                              | description                                                                                                           |   relevancy |
|:--------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------|------------:|
| Cyber Defense Training                            | Training programs aimed at equipping citizens with skills to combat online disinformation and hybrid warfare tactics. |           4 |
| Open-Source Intelligence Gathering (OSINT)        | Techniques for collecting and analyzing publicly available information to support national defense efforts.           |           5 |
| Civilian Military Training                        | Programs designed to prepare civilians for potential military conflict through various training modules.              |           4 |
| Disinformation Debunking Techniques               | Methods taught to identify and counteract false information disseminated during wartime.                              |           4 |
| Social Media Analysis for Contextual Intelligence | Evaluating social media to understand local narratives and identify misinformation based on regional language usage.  |           3 |
