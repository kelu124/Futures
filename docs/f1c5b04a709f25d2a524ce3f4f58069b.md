# __Breakthrough in Materials Science: Creation of Single-Atom-Thick Gold Sheets__, (from page [20240825](https://kghosh.substack.com/p/20240825).)
...
| name                        | description                                                                                                                                                |   relevancy |
|:----------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Goldene                     | Freestanding, single-atom-thick sheets of gold that could expand materials science applications and exhibit unique properties.                             |           5 |
| Exfoliation Technique       | A novel method of exfoliating gold atoms from a host material to create monolayer structures, potentially applicable to other metals.                      |           4 |
| Light-Activated Cyanide Use | Utilizing light-activated cyanide in a dark environment to facilitate the exfoliation process, demonstrating innovative approaches in material processing. |           3 |
