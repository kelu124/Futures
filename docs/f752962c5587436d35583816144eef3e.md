...
| name                   | description                                                                                                                               |   relevancy |
|:-----------------------|:------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Floating Cities        | Urban areas constructed on floating platforms to adapt to rising sea levels, providing practical housing solutions in vulnerable regions. |           5 |
| Floating Architecture  | Design and construction of buildings on water, aimed at addressing space scarcity and climate adaptation.                                 |           4 |
| Deep Water Sea Cooling | A cooling method using cold water from deep sea to regulate temperature in buildings, reducing energy consumption.                        |           4 |
| Artificial Coral Banks | Structures designed to support marine life and stimulate natural coral growth, enhancing underwater ecosystems.                           |           3 |
| Modular Floating Units | Pre-fabricated living and commercial spaces built to be towed and assembled in water, allowing rapid urban development.                   |           4 |
