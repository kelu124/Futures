# __Understanding the Complexity and Insecurity of Computer Systems and Voting Machines__, from ([6704.0](https://kghosh.substack.com/p/6704.0).)
...
| name                                          | description                                                                                                                     |   relevancy |
|:----------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------|------------:|
| Optical-scan voting machines                  | Machines used to count paper ballots, offering higher accuracy than human counting when not compromised.                        |           4 |
| Cybersecurity advances                        | Research and innovations aimed at improving the security of computer systems amidst growing complexity and insecurity.          |           4 |
| Public-private key authentication for chips   | A proposed system of authentication for processors to enhance security and traceability of chips.                               |           5 |
| Remote management infrastructures             | Technologies like Intel Management Engine that enable remote control of devices, raising security concerns.                     |           3 |
| Custom-designed, application-specific devices | Devices designed for specific functions that could enhance security but are costly to produce compared to general-purpose CPUs. |           4 |
