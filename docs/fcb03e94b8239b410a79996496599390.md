# __Empowering EY Professionals Through the Masters in Sustainability Program__, (from page [20221228](https://kghosh.substack.com/p/20221228).)
...
| name                                 | description                                                                                                     |   relevancy |
|:-------------------------------------|:----------------------------------------------------------------------------------------------------------------|------------:|
| Sustainable Finance                  | A growing field focused on financial practices that support sustainable development and responsible investment. |           5 |
| Impact Entrepreneurship              | Business practices that prioritize social and environmental impacts alongside financial returns.                |           5 |
| Digital Credentials and Badges       | A system for recognizing and validating skills and knowledge acquired through applied learning.                 |           4 |
| Systems Thinking                     | An approach to problem-solving that considers the complex interconnections within systems.                      |           4 |
| Stakeholder Management               | Techniques for effectively engaging and managing relationships with stakeholders in sustainability efforts.     |           4 |
| Design Thinking                      | A human-centered approach to innovation and problem-solving that enhances sustainability solutions.             |           4 |
| Project Management in Sustainability | Guidelines and practices focused on managing projects with sustainability goals.                                |           4 |
