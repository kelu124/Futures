...
| name                             | description                                                                                                                                           |   relevancy |
|:---------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------|------------:|
| Container Shipping Optimization  | Technologies and strategies for optimizing container shipping routes and operations, improving efficiency and reducing costs in a challenging market. |           4 |
| Digital Supply Chain Management  | Emerging tools and platforms that enhance transparency and efficiency in supply chains, particularly in response to fluctuating consumer demands.     |           5 |
| Energy Cost Management Solutions | Innovative technologies aimed at managing and reducing energy costs for shipping companies amid rising energy prices.                                 |           4 |
| Geopolitical Risk Analysis Tools | Advanced analytical tools to assess and mitigate risks associated with geopolitical uncertainties affecting global trade.                             |           3 |
